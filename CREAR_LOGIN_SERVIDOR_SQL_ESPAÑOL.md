# 🔐 Crear Login del Servidor SQL para Usuario 'orion' (Azure en Español)
...
2. **Busca "Servidores SQL"** en el buscador superior
...
2. **Click en "Inicios de sesión SQL"** o **"SQL logins"** en el menú lateral
3. **Click en "+ Nuevo inicio de sesión SQL"** o **"+ Agregar"**
4. **Configura**:
   - **Nombre de inicio de sesión**: `orion`
   - **Contraseña**: `Medellin*2025$/`
   - **Base de datos predeterminada**: `Orion`
   - **Click en "Crear"** o **"Guardar"**

**Opción B: Desde Editor de Consultas (Más Controlado)**

1. **Azure Portal** → Tu servidor SQL `orionbarberia`
2. **Click en "Editor de consultas"** (o ve a tu base de datos `Orion` → "Editor de consultas")
...
1. **En Editor de Consultas**, cambia a tu base de datos `Orion`:
...
1. **Render** → Tu servicio → **"Environment"** o **"Entorno"**
...
Ejecuta este script completo en Editor de Consultas:
...
## 📋 Nombres en Español de Azure Portal

- **Servidores SQL** = SQL servers
- **Editor de consultas** = Query editor
- **Inicios de sesión SQL** = SQL logins
- **Bases de datos SQL** = SQL databases
- **Redes** = Networking
...
En Editor de Consultas, ejecuta:
...
## 🎯 Pasos Inmediatos (En Español)

1. **Azure Portal** → **Servidores SQL** → Tu servidor `orionbarberia`
2. **Click en "Editor de consultas"** (o ve a tu base de datos `Orion` → "Editor de consultas")
3. **Ejecuta el script SQL completo** de arriba
4. **Render** → Environment → Verifica `DB_USER = orion@orionbarberia`
5. **Guarda** y **revisa los logs**

## 🔍 Ubicación en Azure Portal (Español)
